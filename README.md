...
> **Current release:** v0.1.5. Official unsigned packages are produced from one validated `main`
...
1. Open [AniStream Releases](https://github.com/Athen2045/AniStream/releases) and select v0.1.5.
2. Under **Assets**, download the macOS DMG: `AniStream-0.1.5-arm64.dmg`.
3. Open the DMG and drag **AniStream** into **Applications**.
4. Open AniStream from the Applications folder.

AniStream v0.1.5 is not signed or notarized with an Apple Developer ID. If macOS blocks the first
...
1. Open [AniStream Releases](https://github.com/Athen2045/AniStream/releases) and select v0.1.5.
2. Under **Assets**, download `AniStream Setup 0.1.5.exe`.
...
The Windows output is `dist/AniStream Setup 0.1.5.exe`. The macOS output is
`dist/AniStream-0.1.5-arm64.dmg`. The platform workflows build, validate, and upload preview artifacts
